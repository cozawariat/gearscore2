	...
	if record.gs2Available and record.gs2 ~= nil then
		if showCharacterGS2 then
			...
			if showInferredLine then
				...
				tooltip:AddDoubleLine("  |cffffff00!|r " .. tostring(record.specLabel), tostring(record.gs2), activeR, activeG, activeB, activeR, activeG, activeB)
				tooltip:AddDoubleLine("  |cff00ff00?|r " .. tostring(record.offSpecBetterSpecLabel), tostring(record.offSpecBetterGs2), offR, offG, offB, offR, offG, offB)
			else
