...
Tables.SpecProfiles = {
	...
	RETRIBUTION = { role = "MELEE", armor = "PLATE", shield = false, ranged = false, pve = { STR = 4.45, CRIT = 2.45, HIT = 2.8, HASTE = 2.5, EXPERTISE = 2.6, ARP = 3.15, AP = 2.2 }, pvp = { STR = 2.2, CRIT = 1.0, AP = 0.9, RESILIENCE = 2.2 } },
