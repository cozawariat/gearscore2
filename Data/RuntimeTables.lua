...
Tables.DefaultSettings = {
	...
	["showCharacterPvp"] = false,
	["showCharacterAverage"] = false,
	["showCharacterSpec"] = true,
	["showCharacterInferred"] = true,
	["hideCharacterInferredUnderThreshold"] = true,
	...
	["alwaysShowExplainTooltip"] = false,
	["showExplainHeader"] = true,
	["showExplainLegacy"] = false,
	["showExplainZeroComponents"] = false,
	["hideExplainNeutralResilienceMultiplier"] = true,
	["showExplainPveFormula"] = true,
	["showExplainPveParts"] = true,
	["showExplainPveTotals"] = true,
	["showExplainPvpFormula"] = false,
	["showExplainPvpParts"] = false,
	["showExplainPvpTotals"] = false,
	["showExplainFlags"] = true,
	["showExplainTopPveStats"] = false,
	["showExplainTopPvpStats"] = false,
...
Tables.SpecProfiles = {
	...
	-- `allowLowerArmor` stays only on specs where cross-armor PvE BiS is treated as a real model choice.
	-- `hybridCasterItems` stays only on Enhancement because spellhance-style weapons are intentional support.
	WARRIOR_ARMS = { role = "MELEE", armor = "PLATE", shield = false, ranged = false, allowLowerArmor = true, gs2Scale = 0.260, gs2SlotCurves = { [16] = { ilvlStart = 264, ilvlEnd = 284, multiplierHigh = 0.82 }, [13] = { ilvlStart = 264, ilvlEnd = 284, multiplierHigh = 0.92 }, [14] = { ilvlStart = 264, ilvlEnd = 284, multiplierHigh = 0.92 }, [18] = { ilvlStart = 264, ilvlEnd = 284, multiplierHigh = 0.89 } }, pve = { STR = 3.15, CRIT = 1.65, HIT = 2.2, HASTE = 1.05, ARP = 1.65, AP = 1.65, EXPERTISE = 1.8 }, pvp = { STR = 2.2, CRIT = 1.2, HIT = 0.8, HASTE = 0.9, ARP = 1.3, AP = 1.0, RESILIENCE = 2.2 } },
	WARRIOR_FURY = { role = "MELEE", armor = "PLATE", shield = false, ranged = false, dualwield = true, allowLowerArmor = true, gs2Scale = 0.000, gs2SlotCurves = { [16] = { ilvlStart = 252, ilvlEnd = 284, multiplierHigh = 0.74 }, [17] = { ilvlStart = 252, ilvlEnd = 284, multiplierHigh = 0.74 }, [13] = { ilvlStart = 252, ilvlEnd = 284, multiplierHigh = 0.88 }, [14] = { ilvlStart = 252, ilvlEnd = 284, multiplierHigh = 0.88 }, [18] = { ilvlStart = 252, ilvlEnd = 284, multiplierHigh = 0.86 } }, pve = { STR = 2.35, CRIT = 1.15, HIT = 1.80, HASTE = 0.72, ARP = 0.92, AP = 0.98, EXPERTISE = 1.30 }, pvp = { STR = 2.0, CRIT = 1.0, HASTE = 0.8, AP = 0.9, RESILIENCE = 2.2 } },
	WARRIOR_PROTECTION = { role = "TANK", armor = "PLATE", shield = true, ranged = false, gs2Scale = 0.390, pve = { STA = 1.7, STR = 0.85, DEFENSE = 2.4, DODGE = 2.0, PARRY = 1.9, BLOCK = 1.75, BLOCKVALUE = 1.2, HIT = 0.95, EXPERTISE = 1.1 }, pvp = { STR = 0.8, DODGE = 1.4, PARRY = 1.3, BLOCK = 1.2, RESILIENCE = 1.7 } },
	PALADIN_HOLY = { role = "HEALER", armor = "PLATE", shield = true, ranged = false, allowLowerArmor = true, gs2Scale = 0.360, pve = { INT = 2.2, SP = 2.5, HASTE = 1.35, CRIT = 1.15, MP5 = 1.35, SPI = 0.4 }, pvp = { INT = 2.0, SP = 2.4, HASTE = 1.1, CRIT = 0.8, MP5 = 0.8, RESILIENCE = 2.2 } },
	PALADIN_PROTECTION = { role = "TANK", armor = "PLATE", shield = true, ranged = false, gs2Scale = 0.330, pve = { STA = 1.65, STR = 0.82, DEFENSE = 2.4, DODGE = 1.9, PARRY = 1.8, BLOCK = 1.65, BLOCKVALUE = 1.18, HIT = 0.90, EXPERTISE = 1.05 }, pvp = { STR = 0.8, DODGE = 1.4, PARRY = 1.3, BLOCK = 1.2, RESILIENCE = 1.7 } },
	PALADIN_RETRIBUTION = { role = "MELEE", armor = "PLATE", shield = false, ranged = false, allowLowerArmor = true, gs2Scale = 0.100, pve = { STR = 4.55, CRIT = 2.45, HIT = 3.0, HASTE = 2.0, EXPERTISE = 2.85, ARP = 2.75, AP = 2.3 }, pvp = { STR = 2.2, CRIT = 1.0, AP = 0.9, RESILIENCE = 2.2 } },
	HUNTER_BEASTMASTERY = { role = "RANGED", armor = "MAIL", shield = false, ranged = true, allowLowerArmor = true, gs2Scale = 0.480, pve = { AGI = 1.85, RAP = 1.0, AP = 0.62, HIT = 1.25, CRIT = 0.95, HASTE = 0.65, ARP = 0.7 }, pvp = { AGI = 2.1, RAP = 1.0, CRIT = 1.0, HASTE = 0.7, RESILIENCE = 2.2 } },
	HUNTER_MARKSMANSHIP = { role = "RANGED", armor = "MAIL", shield = false, ranged = true, allowLowerArmor = true, gs2Scale = 0.360, pve = { AGI = 2.45, RAP = 1.4, AP = 0.8, HIT = 1.65, CRIT = 1.35, HASTE = 0.9, ARP = 1.45 }, pvp = { AGI = 2.2, RAP = 1.0, CRIT = 1.0, ARP = 1.0, RESILIENCE = 2.2 } },
	HUNTER_SURVIVAL = { role = "RANGED", armor = "MAIL", shield = false, ranged = true, allowLowerArmor = true, gs2Scale = 0.370, pve = { AGI = 2.00, RAP = 1.00, AP = 0.58, HIT = 1.28, CRIT = 0.92, HASTE = 0.68 }, pvp = { AGI = 2.2, CRIT = 1.0, HASTE = 0.8, RESILIENCE = 2.2 } },
	ROGUE_ASSASSINATION = { role = "MELEE", armor = "LEATHER", shield = false, ranged = false, dualwield = true, gs2Scale = 0.780, pve = { AGI = 1.12, AP = 0.48, HIT = 0.70, HASTE = 0.36, CRIT = 0.55, EXPERTISE = 0.55 }, pvp = { AGI = 2.2, AP = 1.0, HASTE = 0.8, CRIT = 0.9, RESILIENCE = 2.2 } },
	ROGUE_COMBAT = { role = "MELEE", armor = "LEATHER", shield = false, ranged = false, dualwield = true, gs2Scale = 0.740, pve = { AGI = 1.04, AP = 0.42, HIT = 0.68, HASTE = 0.36, CRIT = 0.52, ARP = 0.47, EXPERTISE = 0.53 }, pvp = { AGI = 2.0, AP = 0.9, HASTE = 0.7, CRIT = 0.8, RESILIENCE = 2.2 } },
	ROGUE_SUBTLETY = { role = "MELEE", armor = "LEATHER", shield = false, ranged = false, dualwield = true, gs2Scale = 0.380, pve = { AGI = 1.80, AP = 0.88, HIT = 1.30, HASTE = 0.66, CRIT = 0.90, ARP = 0.76, EXPERTISE = 0.95 }, pvp = { AGI = 2.3, AP = 1.0, CRIT = 1.0, RESILIENCE = 2.4 } },
	PRIEST_DISCIPLINE = { role = "HEALER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.360, pve = { INT = 1.7, SP = 1.9, CRIT = 0.95, HASTE = 0.85, MP5 = 0.8, SPI = 0.5 }, pvp = { INT = 2.1, SP = 2.2, CRIT = 0.9, HASTE = 0.8, RESILIENCE = 2.4 } },
	PRIEST_HOLY = { role = "HEALER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.240, pve = { INT = 1.95, SP = 2.45, HASTE = 1.30, CRIT = 1.3, SPI = 1.35, MP5 = 0.95 }, pvp = { INT = 2.0, SP = 2.2, HASTE = 0.9, CRIT = 0.8, SPI = 0.9, RESILIENCE = 2.4 } },
	PRIEST_SHADOW = { role = "CASTER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.240, pve = { INT = 1.0, SP = 1.45, HIT = 0.80, HASTE = 0.50, CRIT = 0.42, SPI = 0.35 }, pvp = { INT = 1.6, SP = 2.3, HASTE = 1.0, CRIT = 0.8, RESILIENCE = 2.3 } },
	DEATHKNIGHT_BLOOD = { role = "TANK", armor = "PLATE", shield = false, ranged = false, gs2Scale = 0.220, pve = { STA = 2.35, STR = 1.45, DEFENSE = 2.95, DODGE = 2.35, PARRY = 2.35, HIT = 1.15, EXPERTISE = 1.35 }, pvp = { STR = 1.0, RESILIENCE = 2.0 } },
	DEATHKNIGHT_FROST = { role = "MELEE", armor = "PLATE", shield = false, ranged = false, dualwield = true, gs2Scale = 0.580, pve = { STR = 2.40, HIT = 1.65, HASTE = 1.00, CRIT = 1.00, EXPERTISE = 1.25, AP = 0.92 }, pvp = { STR = 2.2, CRIT = 0.9, RESILIENCE = 2.2 } },
	DEATHKNIGHT_UNHOLY = { role = "MELEE", armor = "PLATE", shield = false, ranged = false, dualwield = true, gs2Scale = 0.300, pve = { STR = 2.35, HIT = 1.65, HASTE = 1.15, CRIT = 1.05, EXPERTISE = 1.20, AP = 0.95 }, pvp = { STR = 2.2, HASTE = 0.8, RESILIENCE = 2.2 } },
	SHAMAN_ELEMENTAL = { role = "CASTER", armor = "CLOTH", shield = true, ranged = false, gs2Scale = 0.420, pve = { INT = 1.0, SP = 1.55, HIT = 0.95, HASTE = 0.65, CRIT = 0.55, MP5 = 0.45 }, pvp = { INT = 1.5, SP = 2.3, HASTE = 0.9, CRIT = 0.8, RESILIENCE = 2.3 } },
	SHAMAN_ENHANCEMENT = { role = "MELEE", armor = "MAIL", shield = false, ranged = false, dualwield = true, hybridCasterItems = true, gs2Scale = 0.370, pve = { AGI = 2.45, AP = 1.5, HIT = 2.2, HASTE = 1.7, CRIT = 1.45, EXPERTISE = 1.8 }, pvp = { AGI = 1.8, AP = 1.0, HASTE = 0.9, RESILIENCE = 2.2 } },
	SHAMAN_RESTORATION = { role = "HEALER", armor = "MAIL", shield = true, ranged = false, allowLowerArmor = true, gs2Scale = 0.330, pve = { INT = 2.0, SP = 2.25, HASTE = 1.3, CRIT = 0.95, MP5 = 1.15, SPI = 0.2 }, pvp = { INT = 2.0, SP = 2.3, HASTE = 0.9, MP5 = 0.7, RESILIENCE = 2.3 } },
	MAGE_ARCANE = { role = "CASTER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.230, pve = { INT = 1.55, SP = 2.15, HIT = 1.35, HASTE = 0.90, CRIT = 0.85, SPI = 0.3 }, pvp = { INT = 1.8, SP = 2.2, HASTE = 0.9, CRIT = 0.8, RESILIENCE = 2.2 } },
	MAGE_FIRE = { role = "CASTER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.250, pve = { INT = 1.20, SP = 2.00, HIT = 1.15, HASTE = 0.85, CRIT = 0.75, SPI = 0.2 }, pvp = { INT = 1.6, SP = 2.3, HASTE = 1.0, CRIT = 0.8, RESILIENCE = 2.2 } },
	MAGE_FROST = { role = "CASTER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.230, pve = { INT = 1.45, SP = 2.10, HIT = 1.35, HASTE = 0.90, CRIT = 0.85 }, pvp = { INT = 1.6, SP = 2.3, HASTE = 0.9, CRIT = 0.8, RESILIENCE = 2.5 } },
	WARLOCK_AFFLICTION = { role = "CASTER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.230, pve = { INT = 1.5, SP = 2.25, HIT = 1.55, HASTE = 0.95, CRIT = 0.8, SPI = 0.4 }, pvp = { INT = 1.6, SP = 2.3, HASTE = 1.0, RESILIENCE = 2.3 } },
	WARLOCK_DEMONOLOGY = { role = "CASTER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.240, pve = { INT = 1.5, SP = 2.2, HIT = 1.45, HASTE = 0.90, CRIT = 0.9, SPI = 0.3 }, pvp = { INT = 1.6, SP = 2.2, HASTE = 0.9, RESILIENCE = 2.2 } },
	WARLOCK_DESTRUCTION = { role = "CASTER", armor = "CLOTH", shield = false, ranged = false, gs2Scale = 0.170, pve = { INT = 2.0, SP = 2.65, HIT = 1.85, HASTE = 1.20, CRIT = 1.15, SPI = 0.45 }, pvp = { INT = 1.6, SP = 2.3, HASTE = 0.9, CRIT = 0.8, RESILIENCE = 2.3 } },
	DRUID_BALANCE = { role = "CASTER", armor = "LEATHER", shield = false, ranged = false, gs2Scale = 0.180, pve = { INT = 2.4, SP = 3.0, HIT = 2.15, HASTE = 1.6, CRIT = 1.35, SPI = 1.3 }, pvp = { INT = 1.7, SP = 2.2, HASTE = 0.9, CRIT = 0.8, RESILIENCE = 2.3 } },
	DRUID_FERAL_DPS = { role = "MELEE", armor = "LEATHER", shield = false, ranged = false, gs2Scale = 0.320, pve = { AGI = 2.20, AP = 0.95, HIT = 1.45, HASTE = 0.70, CRIT = 1.05, ARP = 1.00, EXPERTISE = 1.05 }, pvp = { AGI = 2.2, AP = 0.9, RESILIENCE = 2.3 } },
	DRUID_FERAL_TANK = { role = "TANK", armor = "LEATHER", shield = false, ranged = false, gs2Scale = 0.320, pve = { STA = 2.35, AGI = 1.75, DODGE = 1.45, DEFENSE = 0.60, HIT = 0.90, EXPERTISE = 1.05, AP = 0.32, CRIT = 0.42 }, pvp = { STA = 1.6, AGI = 1.8, DODGE = 1.0, RESILIENCE = 2.3 } },
	DRUID_RESTORATION = { role = "HEALER", armor = "LEATHER", shield = false, ranged = false, gs2Scale = 0.160, pve = { INT = 3.2, SP = 3.3, HASTE = 2.1, CRIT = 1.25, MP5 = 1.55, SPI = 1.65 }, pvp = { INT = 2.0, SP = 2.2, HASTE = 0.9, SPI = 0.7, RESILIENCE = 2.4 } },
}
...
Tables.CapProfiles = {
	WARRIOR_ARMS = {
		...
		pools = {
			HIT = { summary = "Hit", meleeHitBonus = 0, overflow = GS_CapSegmentDefaults.HIT_OVERFLOW, segments = { { mode = "MELEE_HIT_PERCENT", threshold = 9, mult = GS_CapSegmentDefaults.CRITICAL, label = "Special hit cap" } } },
			EXPERTISE = { summary = "Expertise", overflow = GS_CapSegmentDefaults.OVERFLOW, segments = { { mode = "EXPERTISE_POINTS", threshold = 30, mult = GS_CapSegmentDefaults.CRITICAL, label = "Expertise soft cap" } } },
			ARP = { summary = "Armor Penetration", overflow = GS_CapSegmentDefaults.ARP_OVERFLOW, segments = { { mode = "RATING", threshold = 1600, mult = GS_CapSegmentDefaults.CRITICAL, label = "Armor penetration hard cap" } } },
		},
	},
	WARRIOR_FURY = {
		order = { "HIT", "EXPERTISE", "ARP" },
		pools = {
			HIT = { summary = "Hit", meleeHitBonus = 0, overflow = GS_CapSegmentDefaults.HIT_OVERFLOW, segments = { { mode = "MELEE_HIT_PERCENT", threshold = 10, mult = GS_CapSegmentDefaults.CRITICAL, label = "Special hit cap" } } },
			EXPERTISE = { summary = "Expertise", overflow = GS_CapSegmentDefaults.OVERFLOW, segments = { { mode = "EXPERTISE_POINTS", threshold = 32, mult = GS_CapSegmentDefaults.CRITICAL, label = "Expertise soft cap" } } },
			ARP = { summary = "Armor Penetration", overflow = GS_CapSegmentDefaults.ARP_OVERFLOW, segments = { { mode = "RATING", threshold = 1700, mult = GS_CapSegmentDefaults.CRITICAL, label = "Armor penetration hard cap" } } },
		},
	},
	WARRIOR_PROTECTION = {
