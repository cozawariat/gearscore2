...
GS.Constants = GS.Constants or {
	...
	CACHE_TTL = 180,
	FRESH_TTL = 15,
	INSPECT_CACHE_MAX = 300,
	INSPECT_CACHE_TRIM_TO = 220,
	READY_DELAY = 0.15,
	READY_RETRY_LIMIT = 4,
	MIN_INSPECT_ITEMS = 8,
	...
	OFFSPEC_FIT_MATCH_RATIO_FLOOR = 0.35,
	OFFSPEC_FIT_MATCH_RATIO_FULL = 0.75,
	OFFSPEC_FIT_MULTIPLIER_FLOOR = 0.45,
	OFFSPEC_FIT_SIGNATURE_PENALTY = 0.80,
	INCOMPATIBLE_PVE_BONUS_SCALE = 0.15,
	GEM_SCALE = 0.35,
	ENCHANT_SCALE = 0.35,
